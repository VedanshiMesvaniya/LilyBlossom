...
export function SeriesListPage() {
  ...
  useEffect(() => {
    ...
    getTitlesByType(supabase, "series", { releaseStatus, sort }, { page, pageSize: DEFAULT_PAGE_SIZE }).then(
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <h1 className="font-display text-3xl text-text-primary">Series</h1>
      ...
      <MediaGrid
        ...
        loading={loading}
        error={error}
        emptyLabel="No GL series match these filters yet."
      />
